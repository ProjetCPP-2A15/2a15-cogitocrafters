...
try:
    ...
    classnames = []
    classfile = 'C:/Users/meddh/Desktop/noblePalette/noblePalette/script/guest/persondetector/files/thing.names'
    with open(classfile, 'rt') as f:
        classnames = f.read().rstrip('\n').split('\n')

    # Définir les chemins des fichiers de modèle
    p = 'C:/Users/meddh/Desktop/noblePalette/noblePalette/script/guest/persondetector/files/frozen_inference_graph.pb'
    v = 'C:/Users/meddh/Desktop/noblePalette/noblePalette/script/guest/persondetector/files/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'
