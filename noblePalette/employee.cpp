...
QSqlQueryModel * employee::afficherEmployee()
{
    QSqlQueryModel* model=new  QSqlQueryModel();
          model->setQuery("SELECT cast(id as varchar(255)),name,lastname,address,function,phoneNumber,mail FROM employee");
          ...
          model->setHeaderData(5, Qt::Horizontal, QObject::tr("phoneNumber"));
