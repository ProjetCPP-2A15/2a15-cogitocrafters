...
public:
    Article(){}
    Article(QString, QString, QString, QString, QString, int, int, QString ,QString,int,int);
    ...
    bool modifier(int id_article,const QString &domaine, const QString &nom, const QString &date_creation, const QString &type, const QString &dimension, int poids, int prix, const QString &description, const QString &chemin_image,int,int);
