        ...
        void on_listtoaddpro_clicked();
                ...
                //association
                        ...
                        // **************************************************** arduino yassine w iheb ******************************************************
                                                ...
                                                void update_labels();   // slot permettant la mise à jour du label état de la lampe 1,
                                                ...
                                                void on_on_3_clicked();


                                                void on_weathergenerate_2_clicked();

                                                void on_face_clicked();
                   //**********************************************arduino farah emna**************************************************
                                                void on_ArduinoEvent_clicked();
                                                void verifyRFID();



                                                void on_pushButtonEmployee_2_clicked();

                                                void on_supprimer_Employee_3_clicked();

                                                void on_statEmployee_2_clicked();

                                                void on_AddEmployee_3_clicked();

                                                void on_clearEmployee_2_clicked();

                                                void on_updateEmployee_10_clicked();

                                                void on_pdfEmployee_2_clicked();

                                                void on_save_AddEmployee_2_clicked();
...
private:
 ...
 QTimer *timer;
    ...
    void displayArticleViewsById(int ) ;
