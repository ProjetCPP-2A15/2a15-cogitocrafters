...
Article::Article(QString domaine_article, QString nom_article, QString date_creation_article, QString type_article, QString dimension_article, int poids_article, int prix_article, QString description_article, QString chemin_image,int idArtiste,int idVisiteur)
{
...
{
    QSqlQuery query;
    query.prepare("INSERT INTO ARTICLE (domaine_article, nom_article, date_creation_article, type_article, dimension_article, poids_article, prix_article, description_article, chemin_image,id_artiste,id_visiteur) "
                          "VALUES (:domaine_article, :nom_article, :date_creation_article, :type_article, :dimension_article, :poids_article, :prix_article, :description_article, :chemin_image,:id_artiste,:id_visiteur)");
...
bool Article::modifier(int id_article, const QString &domaine, const QString &nom, const QString &date_creation, const QString &type, const QString &dimension, int poids, int prix, const QString &description, const QString &chemin_image, int idArtiste,int idVisiteur) {
    QSqlQuery query;
    query.prepare("UPDATE ARTICLE SET domaine_article = :domaine, nom_article = :nom, date_creation_article = :date_creation, type_article = :type, dimension_article = :dimension, poids_article = :poids, prix_article = :prix, description_article = :description, chemin_image = :chemin_image , id_artiste = :id_artiste ,id_visiteur = :id_visiteur WHERE id_article = :id_article");
    query.bindValue(":id_article", id_article);
